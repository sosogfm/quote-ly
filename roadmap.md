...
## Done
- [x] Phase 1: Workspace shell + streaming chat (Groq via BYOK)
- [x] Phase 2: Account memory (user_memories + remember tool + MemorySettings)
- [x] Central de Evolução Stage 1: backend (evolution-propose, evolution-action), UI (Evolution, EvolutionProposal, components), tests
